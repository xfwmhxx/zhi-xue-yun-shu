...
class StandardAppService {
  ...
  generateAIAgent = async (
    ...
    return fetch(`${this.appServer}/v2/aiagent/generateAIAgentCall`, {
      method: 'POST',
      headers: {
  ...
  getRtcAuthToken = async (userId: string, channelId: string) => {
    ...
    return fetch(`${this.appServer}/v2/aiagent/getRtcAuthToken`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
  ...
  describeAIAgentInstance = async (
    ...
    return fetch(`${this.appServer}/v2/aiagent/describeAIAgentInstance`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: token || '',
  ...
  describeAIAgent = async (
    ...
    return fetch(`${this.appServer}/v2/aiagent/describeAIAgent`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: this.serverAuth || '',
      ...
      .then((data) => {
        ...
        throw new AICallAgentError(
          `describeAIAgent error, message: ${data.message || 'request error'}`,
        )
      })
  }
  ...
  generateMessageChatToken = async (
    ...
    return fetch(`${this.appServer}/v2/aiagent/generateMessageChatToken`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: token || '',
  ...
  startAIAgentOutboundCall = async (userId: string, phoneNumber: string, config: AICallConfig) => {
    ...
    return fetch(`${this.appServer}/v2/aiagent/startAIAgentOutboundCall`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: this.serverAuth || '',
  ...
  getOssConfig = async (userId: string): Promise<JSONObject> => {
    ...
    return fetch(`${this.appServer}/v2/aiagent/getOssConfig`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: this.serverAuth || '',
      ...
      .then((data) => {
        ...
        throw new AICallAgentError(
          `getOssConfig error, message: ${data.message || 'request error'}`,
        )
      })
  }
  ...
  setAIAgentVoiceprint = async (
    ...
    return fetch(`${this.appServer}/v2/aiagent/setAIAgentVoiceprint`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: this.serverAuth || '',
      ...
      .then((data) => {
        ...
        throw new AICallAgentError(
          `setAIAgentVoiceprint error, message: ${data.message || 'request error'}`,
        )
      })
  }
}
